...
Similarly, to cosine, differentiate $\cos x$ got $\cos^\prime x=\cos x\left(\frac{\cos\dd x-1}{\dd x}\right)-\sin x\left(\frac{\sin\dd x}{\dd x}\right)=\cos x\cos^\prime 0-\sin x\sin^\prime 0=-\sin x$.
\end{proof}
\begin{figure}[H]
  \centering
